...
var (
	...
	VulkanVisibleDevices  = String("GGML_VK_VISIBLE_DEVICES")
)
...
func AsMap() map[string]EnvVar {
	...
	if runtime.GOOS != "darwin" {
		...
		ret["MUSA_VISIBLE_DEVICES"] = EnvVar{"MUSA_VISIBLE_DEVICES", MusaVisibleDevices(), "Set which Intel devices are visible by numeric ID"}
		ret["GGML_VK_VISIBLE_DEVICES"] = EnvVar{"GGML_VK_VISIBLE_DEVICES", VulkanVisibleDevices(), "Set which Vulkan devices are visible by numeric ID"}
	}
